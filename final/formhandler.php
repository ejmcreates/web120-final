...
$body ="First message from the website:\n";
...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: eljones.millson@gmail.com' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Second message from the website'; // if your client has more than one web site, you can put the site name here.
...
mail ('eljones.millson@gmail.com', $subject, $body, $from);
